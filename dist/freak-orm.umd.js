(function (global, factory) {
    ...
    class ModelFacade extends EventEmitter {
        ...
        async connect(data) {
            ...
            return beforeConnectEvent.wait(data).then(data => this._model.connect(data)).then(data => afterConnectEvent.wait(data));
        }
        ...
        async disconnect(data) {
            ...
            return beforeDisconnectEvent.wait(data).then(data => this._model.disconnect(data)).then(data => afterDisconnectEvent.wait(data));
        }
